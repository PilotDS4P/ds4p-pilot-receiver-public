...
public class SAMLCallBackHandler implements CallbackHandler {
    ...
    String client_priv_key_alias="ds4p";
    ...
    public SAMLCallBackHandler() {
        try {
            ...
            this.keyStoreURL = home + fileSeparator + "domains" + fileSeparator + "domain1" +
                    fileSeparator + "config" + fileSeparator + "ds4p.jks";
    ...
    private Element createSAMLAssertion() {
        try {
            ...
            String aID = SAMLTokenConstants.getMESSAGE_ID();                       
    ...
    private static List getAttributeList(SAMLAssertionFactory factory) {
            ...
            try {
                ...
                //add organization
                attributeValues = new LinkedList();
                attributeValues.add(SAMLTokenConstants.getUSER_ORGANIZATION());
                attributes.add(factory.createAttribute(DS4PConstants.SUBJECT_ORGANIZATION_NS, attributeValues));
                
                // add organization unit
                attributeValues = new LinkedList();
                attributeValues.add(SAMLTokenConstants.getUSER_ORGANIZATION_UNIT());
                attributes.add(factory.createAttribute(DS4PConstants.SUBJECT_ORGANIZATION_ID_NS, attributeValues));
