...
//        dp.setConfidentiality("R");
        ...
        try {
            ...
            while (ze != null) {
                ...
                else if (fname.equals("SUBSET01/METADATA.xml")) {
...
//        }
    ...
    private String getDecryptedDocument(Key docKey, Key maskKey, Document doc) {
        ...
        try {
            ...
            Document d;
            if (docKey != null) {
                d = DecryptTool.getUnencryptedDocument(docKey, maskKey, doc);
            }
            else {
                d = doc;
            }
                ...
                for (JAXBElement<? extends IdentifiableType> jaxb : extrinsicObjects) {
                    if (jaxb.getValue() instanceof ExtrinsicObjectType) {
                        ...
                        while (cIter.hasNext()) {
                            ...
                            if (cType.getId().equals("c13625828126758631581728852701303")) {
                            ...
                            else if (cType.getId().equals("c1362582812675-28290981051028160472")) {
                                dp.setRefrainPolicy(cType.getNodeRepresentation());
                            }
                            else if (cType.getId().equals("c136258281267552532300929231322554")) {
                                dp.setPou(cType.getNodeRepresentation());
                            }
                            else {
                                //dont care
                            }  
