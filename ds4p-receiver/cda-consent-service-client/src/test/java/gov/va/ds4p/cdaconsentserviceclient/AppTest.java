    ...
    extends TestCase
{
    ...
    public AppTest( String testName )
    {
        ...
        allowedRecipients = Arrays.asList(new String[]{"Duane_Decouteau@direct.healthvault-stage.com", "mike.davis@va.gov", "michael.dufel@jerichosystems.com", "burak.tasel@feisystems.com"});
